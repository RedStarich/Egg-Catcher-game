...
def check_catch():
    (catcher_start_x, catcher_start_y, catcher_start_x2, catcher_start_y2) = c.coords(catcher)
    for egg in eggs:
        (egg_x, egg_y, egg_x2, egg_y2) = c.coords(egg)
        if catcher_start_x < egg_x and egg_x2 < catcher_start_x2 and catcher_start_y2 - egg_y2 < 40:
            eggs.remove(egg)
            c.delete(egg)
